...
@app.get('/sort')
def sort_patients(sort_by: str = Query(..., description='Sort on the basis of height and bmi , weight'), order: str = Query('asc', description='sort in asc and desc order')):
...
def create_patient(patient: Patient):
    ...
    logger.info(f"Patient payload: {patient}")
     # load existing data
    data = load_data()
